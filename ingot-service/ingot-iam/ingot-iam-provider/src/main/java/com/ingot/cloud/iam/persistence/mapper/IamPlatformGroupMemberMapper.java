...
/**
 * <p>映射iam_platform_group_member，由 IAM Repository 显式限定归属，不应用旧租户及权限语义。</p>
 * @author jy
 * @since 1.0.0
...
public interface IamPlatformGroupMemberMapper extends BaseMapper<IamPlatformGroupMemberEntity> {
}
