...
import com.ingot.cloud.iam.api.model.dto.user.UserInfoDTO;
import com.ingot.cloud.iam.api.model.vo.auth.UserEffectivePermissionVO;
import com.ingot.cloud.iam.api.model.vo.menu.MenuTreeNodeVO;
import com.ingot.cloud.iam.authorization.ApplicationAuthorizationResolver;
import com.ingot.cloud.iam.common.BizUtils;
import com.ingot.cloud.iam.service.biz.BizAuthService;
