...
/**
 * <p>映射iam_policy_selector_department，由 IAM Repository 显式限定归属，不应用旧租户及权限语义。</p>
 * @author jy
 * @since 1.0.0
...
public interface IamPolicySelectorDepartmentMapper extends BaseMapper<IamPolicySelectorDepartmentEntity> {
}
