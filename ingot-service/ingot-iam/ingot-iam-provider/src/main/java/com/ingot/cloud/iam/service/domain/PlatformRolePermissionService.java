...
import com.ingot.cloud.iam.api.model.domain.PlatformRolePermission;
 ...
 * @since 2025-11-12
 */
public interface PlatformRolePermissionService extends BaseService<PlatformRolePermission> {
