package com.ingot.cloud.iam.web.v1.platform.admin;
...
import com.ingot.cloud.iam.api.model.dto.user.AccountLockDTO;
import com.ingot.cloud.iam.api.model.dto.user.AllOrgUserFilterDTO;
import com.ingot.cloud.iam.api.model.dto.user.UserBaseInfoDTO;
import com.ingot.cloud.iam.api.model.dto.user.UserDTO;
import com.ingot.cloud.iam.api.model.vo.user.SimpleUserWithPhoneVO;
 ...
 */
@Slf4j
@Tag(description = "AdminUser", name = "系统用户管理模块")
@RestController
...
public class SystemUserAPI implements RShortcuts {
    ...
    @AdminOrHasAnyAuthority({"platform:admin:user:search"})
