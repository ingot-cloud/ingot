...
import com.ingot.cloud.iam.api.model.types.MenuType;
...
/**
 * <p>平台菜单实体，归属于应用；受保护页面通过可见性关联权限，不再托管权限生命周期。</p>
 *
 * @author jymot
 * @since 2025-11-12
 */
...
public class PlatformMenu extends BaseModel<PlatformMenu> implements MenuType {
    @Serial
    ...
    /**
     * 受保护页面的权限匹配模式，缺省 {@link PermissionMatchModeEnum#ANY}
     */
