...
) ENGINE=InnoDB AUTO_INCREMENT=283 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='账号锁定状态表';
...
INSERT INTO `account_lock_state` (`id`, `user_id`, `user_type`, `locked`, `lock_type`, `lock_reason_code`, `lock_reason_detail`, `locked_at`, `locked_until`, `operator_id`, `operator_name`, `failed_login_count`, `last_failed_at`, `created_at`, `updated_at`) VALUES (48, 1247573787441106945, '0', 0, 'AUTO', 'LOGIN_FAIL', NULL, '2026-08-13 14:46:10', '2026-08-13 15:16:10', 1, 'platform', 0, NULL, '2026-06-23 15:18:51', '2026-08-13 15:17:00');
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=1258708277151367171 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='密码过期信息';
...
) ENGINE=InnoDB AUTO_INCREMENT=1266024285766643714 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='密码历史记录（环形缓冲）';
...
INSERT INTO `password_history` (`id`, `user_id`, `password_hash`, `sequence_number`, `version`, `created_at`, `updated_at`) VALUES (1257726231927676930, 1247573787441106945, '{bcrypt}$2a$10$vw6Ek8PXuuBiCnMVYxapg.fbgHgR/U/ijL0lQMiNTq2RYIZctj0w.', 1, 1, '2026-07-21 15:41:02', '2026-07-21 15:41:02');
INSERT INTO `password_history` (`id`, `user_id`, `password_hash`, `sequence_number`, `version`, `created_at`, `updated_at`) VALUES (1264266598510981122, 1247573787441106945, '{bcrypt}$2a$10$xmh6AS/M8l/3l1YMQkYewO7ytKyL4AfKxksk7hw14LvD4WCGv44ta', 2, 2, '2026-08-08 16:50:07', '2026-08-08 16:50:07');
INSERT INTO `password_history` (`id`, `user_id`, `password_hash`, `sequence_number`, `version`, `created_at`, `updated_at`) VALUES (1264992122917056513, 1247573787441106945, '{bcrypt}$2a$10$7UInCWJr0TZ05FRyNhR17.2ZLcj2OwpewFZpI32OSw4y.KQaW8TuC', 3, 3, '2026-08-10 16:53:06', '2026-08-10 16:53:06');
INSERT INTO `password_history` (`id`, `user_id`, `password_hash`, `sequence_number`, `version`, `created_at`, `updated_at`) VALUES (1266024285766643713, 1247573787441106945, '{bcrypt}$2a$10$mZrAs/5odQ8I5Tj1KvfVAOiGi61/xKecIqYtxIBfl09VJrbW9B0f6', 4, 4, '2026-08-13 13:14:32', '2026-08-13 13:14:32');
COMMIT;
...
INSERT INTO `platform_app` (`id`, `code`, `app_type`, `menu_id`, `permission_id`, `name`, `icon`, `intro`, `sort`, `status`, `created_at`, `updated_at`, `deleted_at`) VALUES (1247491651069546497, 'asdasd', '1', 0, 1247491651010826241, 'Test', NULL, '111', 100, '0', '2026-06-23 09:52:28', '2026-06-23 09:52:28', '2026-06-23 02:00:01');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `platform_menu` (`id`, `pid`, `app_id`, `name`, `menu_type`, `path`, `access_mode`, `permission_id`, `view_path`, `route_name`, `redirect`, `icon`, `sort`, `is_cache`, `hidden`, `hide_breadcrumb`, `props`, `org_type`, `link_type`, `link_url`, `status`, `remark`, `created_at`, `updated_at`, `deleted_at`) VALUES (1246864778740072450, 0, 1246850914065547265, '平台配置', '0', '/platform/config', '1', 1246850914036187138, 'layout.main', NULL, '/platform/config/app/home', 'mynaui:config', 10, 0, 0, 0, 0, '0', '0', NULL, '0', '平台统一配置', '2026-06-21 16:21:30', '2026-06-23 11:23:53', NULL);
INSERT INTO `platform_menu` (`id`, `pid`, `app_id`, `name`, `menu_type`, `path`, `access_mode`, `permission_id`, `view_path`, `route_name`, `redirect`, `icon`, `sort`, `is_cache`, `hidden`, `hide_breadcrumb`, `props`, `org_type`, `link_type`, `link_url`, `status`, `remark`, `created_at`, `updated_at`, `deleted_at`) VALUES (1246865537795850242, 1246864778740072450, 1246850914065547265, '应用管理', '1', '/platform/config/app/home', '1', 1246865537716158465, 'platform.config.app.home', NULL, NULL, NULL, 10, 0, 0, 0, 0, '0', '0', NULL, '0', NULL, '2026-06-21 16:24:31', '2026-06-21 16:24:31', NULL);
INSERT INTO `platform_menu` (`id`, `pid`, `app_id`, `name`, `menu_type`, `path`, `access_mode`, `permission_id`, `view_path`, `route_name`, `redirect`, `icon`, `sort`, `is_cache`, `hidden`, `hide_breadcrumb`, `props`, `org_type`, `link_type`, `link_url`, `status`, `remark`, `created_at`, `updated_at`, `deleted_at`) VALUES (1246865700434182146, 1246864778740072450, 1246850914065547265, '应用详情', '1', '/platform/config/app/detail/:appId', '1', 1246865700333518849, 'platform.config.app.detail', NULL, NULL, NULL, 20, 0, 1, 0, 1, '0', '0', NULL, '0', NULL, '2026-06-21 16:25:10', '2026-06-22 14:15:41', NULL);
INSERT INTO `platform_menu` (`id`, `pid`, `app_id`, `name`, `menu_type`, `path`, `access_mode`, `permission_id`, `view_path`, `route_name`, `redirect`, `icon`, `sort`, `is_cache`, `hidden`, `hide_breadcrumb`, `props`, `org_type`, `link_type`, `link_url`, `status`, `remark`, `created_at`, `updated_at`, `deleted_at`) VALUES (1246865931452252161, 1246864778740072450, 1246850914065547265, '角色管理', '1', '/platform/config/role', '1', 1246865931389337602, 'platform.config.role', NULL, NULL, NULL, 20, 0, 0, 0, 0, '0', '0', NULL, '0', NULL, '2026-06-21 16:26:05', '2026-06-21 19:19:53', NULL);
INSERT INTO `platform_menu` (`id`, `pid`, `app_id`, `name`, `menu_type`, `path`, `access_mode`, `permission_id`, `view_path`, `route_name`, `redirect`, `icon`, `sort`, `is_cache`, `hidden`, `hide_breadcrumb`, `props`, `org_type`, `link_type`, `link_url`, `status`, `remark`, `created_at`, `updated_at`, `deleted_at`) VALUES (1246895217429151746, 1246864778740072450, 1246850914065547265, '菜单管理', '1', '/platform/config/menu', '1', 1246895217303322625, 'platform.config.menu', NULL, NULL, NULL, 30, 0, 0, 0, 0, '0', '0', NULL, '0', NULL, '2026-06-21 18:22:27', '2026-06-21 18:22:38', NULL);
INSERT INTO `platform_menu` (`id`, `pid`, `app_id`, `name`, `menu_type`, `path`, `access_mode`, `permission_id`, `view_path`, `route_name`, `redirect`, `icon`, `sort`, `is_cache`, `hidden`, `hide_breadcrumb`, `props`, `org_type`, `link_type`, `link_url`, `status`, `remark`, `created_at`, `updated_at`, `deleted_at`) VALUES (1246895376481353730, 1246864778740072450, 1246850914065547265, '权限管理', '1', '/platform/config/permission', '1', 1246895376431022081, 'platform.config.permission', NULL, NULL, NULL, 40, 0, 0, 0, 0, '0', '0', NULL, '0', NULL, '2026-06-21 18:23:05', '2026-06-21 18:23:05', NULL);
INSERT INTO `platform_menu` (`id`, `pid`, `app_id`, `name`, `menu_type`, `path`, `access_mode`, `permission_id`, `view_path`, `route_name`, `redirect`, `icon`, `sort`, `is_cache`, `hidden`, `hide_breadcrumb`, `props`, `org_type`, `link_type`, `link_url`, `status`, `remark`, `created_at`, `updated_at`, `deleted_at`) VALUES (1246908429054738433, 1246864778740072450, 1246850914065547265, '字典管理', '1', '/platform/config/dict', '1', 1246908428983435266, 'platform.config.dict', NULL, NULL, NULL, 50, 0, 0, 0, 0, '0', '0', NULL, '0', NULL, '2026-06-21 19:14:57', '2026-06-21 19:15:08', NULL);
INSERT INTO `platform_menu` (`id`, `pid`, `app_id`, `name`, `menu_type`, `path`, `access_mode`, `permission_id`, `view_path`, `route_name`, `redirect`, `icon`, `sort`, `is_cache`, `hidden`, `hide_breadcrumb`, `props`, `org_type`, `link_type`, `link_url`, `status`, `remark`, `created_at`, `updated_at`, `deleted_at`) VALUES (1246913102880931841, 0, 1246912981145452545, '管理身份', '0', '/platform/admin', '1', 1246912981111898114, 'layout.main', NULL, '/platform/admin/user', 'eos-icons:admin', 10, 0, 0, 0, 0, '0', '0', NULL, '0', NULL, '2026-06-21 19:33:31', '2026-06-21 19:33:31', NULL);
INSERT INTO `platform_menu` (`id`, `pid`, `app_id`, `name`, `menu_type`, `path`, `access_mode`, `permission_id`, `view_path`, `route_name`, `redirect`, `icon`, `sort`, `is_cache`, `hidden`, `hide_breadcrumb`, `props`, `org_type`, `link_type`, `link_url`, `status`, `remark`, `created_at`, `updated_at`, `deleted_at`) VALUES (1246913272867684353, 1246913102880931841, 1246912981145452545, '用户管理', '1', '/platform/admin/user', '1', 1246913272758632449, 'platform.admin.user', NULL, NULL, NULL, 10, 0, 0, 0, 0, '0', '0', NULL, '0', NULL, '2026-06-21 19:34:12', '2026-06-21 19:34:12', NULL);
INSERT INTO `platform_menu` (`id`, `pid`, `app_id`, `name`, `menu_type`, `path`, `access_mode`, `permission_id`, `view_path`, `route_name`, `redirect`, `icon`, `sort`, `is_cache`, `hidden`, `hide_breadcrumb`, `props`, `org_type`, `link_type`, `link_url`, `status`, `remark`, `created_at`, `updated_at`, `deleted_at`) VALUES (1246915250167447553, 0, 1246915131086962690, '用户身份', '0', '/platform/member', '1', 1246915131061796866, 'layout.main', NULL, '/platform/member/user', 'carbon:app', 10, 0, 0, 0, 0, '0', '0', NULL, '0', NULL, '2026-06-21 19:42:03', '2026-06-21 19:42:03', NULL);
INSERT INTO `platform_menu` (`id`, `pid`, `app_id`, `name`, `menu_type`, `path`, `access_mode`, `permission_id`, `view_path`, `route_name`, `redirect`, `icon`, `sort`, `is_cache`, `hidden`, `hide_breadcrumb`, `props`, `org_type`, `link_type`, `link_url`, `status`, `remark`, `created_at`, `updated_at`, `deleted_at`) VALUES (1246915377313579010, 1246915250167447553, 1246915131086962690, '用户管理', '1', '/platform/member/user', '1', 1246915377242275841, 'member.user', NULL, NULL, NULL, 10, 0, 0, 0, 0, '0', '0', NULL, '0', NULL, '2026-06-21 19:42:34', '2026-06-21 19:42:34', NULL);
INSERT INTO `platform_menu` (`id`, `pid`, `app_id`, `name`, `menu_type`, `path`, `access_mode`, `permission_id`, `view_path`, `route_name`, `redirect`, `icon`, `sort`, `is_cache`, `hidden`, `hide_breadcrumb`, `props`, `org_type`, `link_type`, `link_url`, `status`, `remark`, `created_at`, `updated_at`, `deleted_at`) VALUES (1246915435408883713, 1246915250167447553, 1246915131086962690, '角色管理', '1', '/platform/member/role', '1', 1246915435329191938, 'member.role', NULL, NULL, NULL, 20, 0, 0, 0, 0, '0', '0', NULL, '0', NULL, '2026-06-21 19:42:47', '2026-06-21 19:42:47', NULL);
INSERT INTO `platform_menu` (`id`, `pid`, `app_id`, `name`, `menu_type`, `path`, `access_mode`, `permission_id`, `view_path`, `route_name`, `redirect`, `icon`, `sort`, `is_cache`, `hidden`, `hide_breadcrumb`, `props`, `org_type`, `link_type`, `link_url`, `status`, `remark`, `created_at`, `updated_at`, `deleted_at`) VALUES (1246918584295194625, 0, 1246918461083320321, '组织管理', '0', '/platform/org', '1', 1246918461028794369, 'layout.main', NULL, '/platform/org/tenant', 'clarity:organization-line', 10, 0, 0, 0, 0, '0', '0', NULL, '0', NULL, '2026-06-21 19:55:18', '2026-06-21 19:55:18', NULL);
INSERT INTO `platform_menu` (`id`, `pid`, `app_id`, `name`, `menu_type`, `path`, `access_mode`, `permission_id`, `view_path`, `route_name`, `redirect`, `icon`, `sort`, `is_cache`, `hidden`, `hide_breadcrumb`, `props`, `org_type`, `link_type`, `link_url`, `status`, `remark`, `created_at`, `updated_at`, `deleted_at`) VALUES (1246918643413909506, 1246918584295194625, 1246918461083320321, '组织管理', '1', '/platform/org/tenant', '1', 1246918643338412034, 'platform.org.tenant', NULL, NULL, NULL, 10, 0, 0, 0, 0, '0', '0', NULL, '0', NULL, '2026-06-21 19:55:32', '2026-06-21 19:55:32', NULL);
INSERT INTO `platform_menu` (`id`, `pid`, `app_id`, `name`, `menu_type`, `path`, `access_mode`, `permission_id`, `view_path`, `route_name`, `redirect`, `icon`, `sort`, `is_cache`, `hidden`, `hide_breadcrumb`, `props`, `org_type`, `link_type`, `link_url`, `status`, `remark`, `created_at`, `updated_at`, `deleted_at`) VALUES (1247136877864050690, 0, 1247136775485284354, '安全中心', '0', '/platform/security', '1', 1247136775460118530, 'layout.main', NULL, '/platform/security/credential', 'ic:sharp-security', 10, 0, 0, 0, 0, '0', '0', NULL, '0', NULL, '2026-06-22 10:22:43', '2026-06-22 10:22:43', NULL);
INSERT INTO `platform_menu` (`id`, `pid`, `app_id`, `name`, `menu_type`, `path`, `access_mode`, `permission_id`, `view_path`, `route_name`, `redirect`, `icon`, `sort`, `is_cache`, `hidden`, `hide_breadcrumb`, `props`, `org_type`, `link_type`, `link_url`, `status`, `remark`, `created_at`, `updated_at`, `deleted_at`) VALUES (1247136994348261378, 1247136877864050690, 1247136775485284354, '凭证策略', '1', '/platform/security/credential', '1', 1247136994251792386, 'security.credential', NULL, NULL, NULL, 10, 0, 0, 0, 0, '0', '0', NULL, '0', NULL, '2026-06-22 10:23:11', '2026-06-22 10:23:11', NULL);
INSERT INTO `platform_menu` (`id`, `pid`, `app_id`, `name`, `menu_type`, `path`, `access_mode`, `permission_id`, `view_path`, `route_name`, `redirect`, `icon`, `sort`, `is_cache`, `hidden`, `hide_breadcrumb`, `props`, `org_type`, `link_type`, `link_url`, `status`, `remark`, `created_at`, `updated_at`, `deleted_at`) VALUES (1247137066855194626, 1247136877864050690, 1247136775485284354, '在线用户', '1', '/platform/security/onlinetoken', '1', 1247137066804862978, 'security.sessions', NULL, NULL, NULL, 10, 0, 0, 0, 0, '0', '0', NULL, '0', NULL, '2026-06-22 10:23:29', '2026-06-22 10:23:29', NULL);
INSERT INTO `platform_menu` (`id`, `pid`, `app_id`, `name`, `menu_type`, `path`, `access_mode`, `permission_id`, `view_path`, `route_name`, `redirect`, `icon`, `sort`, `is_cache`, `hidden`, `hide_breadcrumb`, `props`, `org_type`, `link_type`, `link_url`, `status`, `remark`, `created_at`, `updated_at`, `deleted_at`) VALUES (1247137808659800065, 0, 1247137699024887810, '开发者平台', '0', '/platform/develop', '1', 1247137698999721985, 'layout.main', NULL, '/platform/develop/qrcode', 'material-symbols:developer-mode-tv-outline', 10, 0, 0, 0, 0, '0', '0', NULL, '0', NULL, '2026-06-22 10:26:25', '2026-06-22 10:26:25', NULL);
INSERT INTO `platform_menu` (`id`, `pid`, `app_id`, `name`, `menu_type`, `path`, `access_mode`, `permission_id`, `view_path`, `route_name`, `redirect`, `icon`, `sort`, `is_cache`, `hidden`, `hide_breadcrumb`, `props`, `org_type`, `link_type`, `link_url`, `status`, `remark`, `created_at`, `updated_at`, `deleted_at`) VALUES (1247137885637861378, 1247137808659800065, 1247137699024887810, '生成二维码', '1', '/platform/develop/qrcode', '1', 1247137885583335425, 'platform.develop.qrcode', NULL, NULL, NULL, 10, 0, 0, 0, 0, '0', '0', NULL, '0', NULL, '2026-06-22 10:26:44', '2026-06-22 10:26:44', NULL);
INSERT INTO `platform_menu` (`id`, `pid`, `app_id`, `name`, `menu_type`, `path`, `access_mode`, `permission_id`, `view_path`, `route_name`, `redirect`, `icon`, `sort`, `is_cache`, `hidden`, `hide_breadcrumb`, `props`, `org_type`, `link_type`, `link_url`, `status`, `remark`, `created_at`, `updated_at`, `deleted_at`) VALUES (1247137958216097793, 1247137808659800065, 1247137699024887810, '客户端管理', '1', '/platform/develop/client', '1', 1247137958161571842, 'platform.develop.client', NULL, NULL, NULL, 20, 0, 0, 0, 0, '0', '0', NULL, '0', NULL, '2026-06-22 10:27:01', '2026-06-22 10:27:01', NULL);
INSERT INTO `platform_menu` (`id`, `pid`, `app_id`, `name`, `menu_type`, `path`, `access_mode`, `permission_id`, `view_path`, `route_name`, `redirect`, `icon`, `sort`, `is_cache`, `hidden`, `hide_breadcrumb`, `props`, `org_type`, `link_type`, `link_url`, `status`, `remark`, `created_at`, `updated_at`, `deleted_at`) VALUES (1247138012599443457, 1247137808659800065, 1247137699024887810, '社交管理', '1', '/platform/develop/social', '1', 1247138012544917505, 'platform.develop.social', NULL, NULL, NULL, 30, 0, 0, 0, 0, '0', '0', NULL, '0', NULL, '2026-06-22 10:27:14', '2026-06-22 10:27:14', NULL);
INSERT INTO `platform_menu` (`id`, `pid`, `app_id`, `name`, `menu_type`, `path`, `access_mode`, `permission_id`, `view_path`, `route_name`, `redirect`, `icon`, `sort`, `is_cache`, `hidden`, `hide_breadcrumb`, `props`, `org_type`, `link_type`, `link_url`, `status`, `remark`, `created_at`, `updated_at`, `deleted_at`) VALUES (1247138076856180738, 1247137808659800065, 1247137699024887810, '业务ID管理', '1', '/platform/develop/id', '1', 1247138076789071873, 'platform.develop.id', NULL, NULL, NULL, 40, 0, 0, 0, 0, '0', '0', NULL, '0', NULL, '2026-06-22 10:27:29', '2026-06-22 10:27:29', NULL);
INSERT INTO `platform_menu` (`id`, `pid`, `app_id`, `name`, `menu_type`, `path`, `access_mode`, `permission_id`, `view_path`, `route_name`, `redirect`, `icon`, `sort`, `is_cache`, `hidden`, `hide_breadcrumb`, `props`, `org_type`, `link_type`, `link_url`, `status`, `remark`, `created_at`, `updated_at`, `deleted_at`) VALUES (1247138906179133441, 0, 1247138809458483202, '通讯录', '0', '/org/contacts', '1', 1247138809424928770, 'layout.main', NULL, '/org/contacts/user', 'typcn:contacts', 10, 0, 0, 0, 0, '1', '0', NULL, '0', NULL, '2026-06-22 10:30:47', '2026-06-22 10:30:47', NULL);
INSERT INTO `platform_menu` (`id`, `pid`, `app_id`, `name`, `menu_type`, `path`, `access_mode`, `permission_id`, `view_path`, `route_name`, `redirect`, `icon`, `sort`, `is_cache`, `hidden`, `hide_breadcrumb`, `props`, `org_type`, `link_type`, `link_url`, `status`, `remark`, `created_at`, `updated_at`, `deleted_at`) VALUES (1247138952148705281, 1247138906179133441, 1247138809458483202, '成员管理', '1', '/org/contacts/user', '1', 1247138952089985025, 'org.contacts.user', NULL, NULL, NULL, 10, 0, 0, 0, 0, '1', '0', NULL, '0', NULL, '2026-06-22 10:30:58', '2026-06-22 10:30:58', NULL);
INSERT INTO `platform_menu` (`id`, `pid`, `app_id`, `name`, `menu_type`, `path`, `access_mode`, `permission_id`, `view_path`, `route_name`, `redirect`, `icon`, `sort`, `is_cache`, `hidden`, `hide_breadcrumb`, `props`, `org_type`, `link_type`, `link_url`, `status`, `remark`, `created_at`, `updated_at`, `deleted_at`) VALUES (1247138998588039169, 1247138906179133441, 1247138809458483202, '部门管理', '1', '/org/contacts/dept', '1', 1247138998533513218, 'org.contacts.dept', NULL, NULL, NULL, 20, 0, 0, 0, 0, '1', '0', NULL, '0', NULL, '2026-06-22 10:31:09', '2026-06-22 10:31:09', NULL);
INSERT INTO `platform_menu` (`id`, `pid`, `app_id`, `name`, `menu_type`, `path`, `access_mode`, `permission_id`, `view_path`, `route_name`, `redirect`, `icon`, `sort`, `is_cache`, `hidden`, `hide_breadcrumb`, `props`, `org_type`, `link_type`, `link_url`, `status`, `remark`, `created_at`, `updated_at`, `deleted_at`) VALUES (1247139048244404225, 1247138906179133441, 1247138809458483202, '角色管理', '1', '/org/contacts/role', '1', 1247139048185683970, 'org.contacts.role', NULL, NULL, NULL, 30, 0, 0, 0, 0, '1', '0', NULL, '0', NULL, '2026-06-22 10:31:21', '2026-06-22 10:31:21', NULL);
INSERT INTO `platform_menu` (`id`, `pid`, `app_id`, `name`, `menu_type`, `path`, `access_mode`, `permission_id`, `view_path`, `route_name`, `redirect`, `icon`, `sort`, `is_cache`, `hidden`, `hide_breadcrumb`, `props`, `org_type`, `link_type`, `link_url`, `status`, `remark`, `created_at`, `updated_at`, `deleted_at`) VALUES (1247139193258270721, 1247138906179133441, 1247138809458483202, '权限管理', '1', '/org/contacts/auth', '1', 1247139193186967553, 'org.contacts.auth', NULL, NULL, NULL, 40, 0, 0, 0, 0, '1', '0', NULL, '0', NULL, '2026-06-22 10:31:56', '2026-06-22 10:31:56', NULL);
INSERT INTO `platform_menu` (`id`, `pid`, `app_id`, `name`, `menu_type`, `path`, `access_mode`, `permission_id`, `view_path`, `route_name`, `redirect`, `icon`, `sort`, `is_cache`, `hidden`, `hide_breadcrumb`, `props`, `org_type`, `link_type`, `link_url`, `status`, `remark`, `created_at`, `updated_at`, `deleted_at`) VALUES (1247139242579091457, 1247138906179133441, 1247138809458483202, '组织架构', '1', '/org/contacts/structure', '1', 1247139242520371202, 'org.contacts.structure', NULL, NULL, NULL, 50, 0, 0, 0, 0, '1', '0', NULL, '0', NULL, '2026-06-22 10:32:07', '2026-06-22 10:32:07', NULL);
INSERT INTO `platform_menu` (`id`, `pid`, `app_id`, `name`, `menu_type`, `path`, `access_mode`, `permission_id`, `view_path`, `route_name`, `redirect`, `icon`, `sort`, `is_cache`, `hidden`, `hide_breadcrumb`, `props`, `org_type`, `link_type`, `link_url`, `status`, `remark`, `created_at`, `updated_at`, `deleted_at`) VALUES (1247266910561656833, 1247138952148705281, 1247138809458483202, '成员查询', '9', '/org/contacts/user/query', '1', 1247266910431633410, '@/pages/org/contacts/user/query/IndexPage.vue', NULL, NULL, NULL, 10, 0, 0, 0, 0, '1', '0', NULL, '0', NULL, '2026-06-22 18:59:26', '2026-06-22 18:59:26', NULL);
INSERT INTO `platform_menu` (`id`, `pid`, `app_id`, `name`, `menu_type`, `path`, `access_mode`, `permission_id`, `view_path`, `route_name`, `redirect`, `icon`, `sort`, `is_cache`, `hidden`, `hide_breadcrumb`, `props`, `org_type`, `link_type`, `link_url`, `status`, `remark`, `created_at`, `updated_at`, `deleted_at`) VALUES (1247267606753206273, 1247138998588039169, 1247138809458483202, '部门查询', '9', '/org/contacts/dept/query', '1', 1247267606677708802, '@/pages/org/contacts/dept/query/IndexPage.vue', NULL, NULL, NULL, 10, 0, 0, 0, 0, '1', '0', NULL, '0', NULL, '2026-06-22 19:02:12', '2026-06-22 19:02:12', NULL);
INSERT INTO `platform_menu` (`id`, `pid`, `app_id`, `name`, `menu_type`, `path`, `access_mode`, `permission_id`, `view_path`, `route_name`, `redirect`, `icon`, `sort`, `is_cache`, `hidden`, `hide_breadcrumb`, `props`, `org_type`, `link_type`, `link_url`, `status`, `remark`, `created_at`, `updated_at`, `deleted_at`) VALUES (1247268327103946753, 1247139048244404225, 1247138809458483202, '角色查询', '9', '/org/contacts/role/query', '1', 1247268326986506241, '@/pages/org/contacts/role/query/IndexPage.vue', NULL, NULL, NULL, 10, 0, 0, 0, 0, '1', '0', NULL, '0', NULL, '2026-06-22 19:05:03', '2026-06-22 19:05:03', NULL);
INSERT INTO `platform_menu` (`id`, `pid`, `app_id`, `name`, `menu_type`, `path`, `access_mode`, `permission_id`, `view_path`, `route_name`, `redirect`, `icon`, `sort`, `is_cache`, `hidden`, `hide_breadcrumb`, `props`, `org_type`, `link_type`, `link_url`, `status`, `remark`, `created_at`, `updated_at`, `deleted_at`) VALUES (1247268449049141250, 1247139193258270721, 1247138809458483202, '权限查询', '9', '/org/contacts/auth/query', '1', 1247268448994615298, '@/pages/org/contacts/auth/query/IndexPage.vue', NULL, NULL, NULL, 10, 0, 0, 0, 0, '1', '0', NULL, '0', NULL, '2026-06-22 19:05:32', '2026-06-22 19:05:32', NULL);
INSERT INTO `platform_menu` (`id`, `pid`, `app_id`, `name`, `menu_type`, `path`, `access_mode`, `permission_id`, `view_path`, `route_name`, `redirect`, `icon`, `sort`, `is_cache`, `hidden`, `hide_breadcrumb`, `props`, `org_type`, `link_type`, `link_url`, `status`, `remark`, `created_at`, `updated_at`, `deleted_at`) VALUES (1260960888923586562, 1247136877864050690, 1247136775485284354, '访问防护', '1', '/platform/security/access-protection', '1', 1260960888831311873, 'security.access.protection', NULL, NULL, NULL, 10, 0, 0, 0, 0, '0', '0', NULL, '0', NULL, '2026-07-30 13:54:25', '2026-07-30 13:54:25', NULL);
COMMIT;
...
INSERT INTO `platform_permission` (`id`, `app_id`, `pid`, `name`, `code`, `type`, `node_type`, `source_type`, `source_id`, `managed`, `org_type`, `status`, `remark`, `created_at`, `updated_at`, `deleted_at`) VALUES (1247137066804862981, 1247136775485284354, 1247137066804862978, '会话查询', 'platform:security:session:query', '1', '2', '2', NULL, b'0', '0', '0', '安全中心在线会话列表与详情', '2026-08-19 10:00:00', '2026-08-19 10:00:00', NULL);
INSERT INTO `platform_permission` (`id`, `app_id`, `pid`, `name`, `code`, `type`, `node_type`, `source_type`, `source_id`, `managed`, `org_type`, `status`, `remark`, `created_at`, `updated_at`, `deleted_at`) VALUES (1247137066804862982, 1247136775485284354, 1247137066804862978, '会话下线', 'platform:security:session:revoke', '1', '2', '2', NULL, b'0', '0', '0', '安全中心按 sid / 按用户强制下线', '2026-08-19 10:00:00', '2026-08-19 10:00:00', NULL);
INSERT INTO `platform_permission` (`id`, `app_id`, `pid`, `name`, `code`, `type`, `node_type`, `source_type`, `source_id`, `managed`, `org_type`, `status`, `remark`, `created_at`, `updated_at`, `deleted_at`) VALUES (1247137066804862983, 1247136775485284354, 1247137066804862978, '并发策略查询', 'platform:security:session:policy:query', '1', '2', '2', NULL, b'0', '0', '0', '并发会话策略列表与详情', '2026-08-19 10:00:00', '2026-08-19 10:00:00', NULL);
INSERT INTO `platform_permission` (`id`, `app_id`, `pid`, `name`, `code`, `type`, `node_type`, `source_type`, `source_id`, `managed`, `org_type`, `status`, `remark`, `created_at`, `updated_at`, `deleted_at`) VALUES (1247137066804862984, 1247136775485284354, 1247137066804862978, '并发策略维护', 'platform:security:session:policy:update', '1', '2', '2', NULL, b'0', '0', '0', '并发会话策略新增/修改/删除', '2026-08-19 10:00:00', '2026-08-19 10:00:00', NULL);
INSERT INTO `platform_permission` (`id`, `app_id`, `pid`, `name`, `code`, `type`, `node_type`, `source_type`, `source_id`, `managed`, `org_type`, `status`, `remark`, `created_at`, `updated_at`, `deleted_at`) VALUES (1247137066804862985, 1247136775485284354, 1247136775460118530, '账号锁定策略查询', 'platform:security:account:lockout:query', '1', '2', '2', NULL, b'0', '0', '0', '账号锁定策略列表与按用户类型查询', '2026-08-25 00:00:00', '2026-08-25 00:00:00', NULL);
INSERT INTO `platform_permission` (`id`, `app_id`, `pid`, `name`, `code`, `type`, `node_type`, `source_type`, `source_id`, `managed`, `org_type`, `status`, `remark`, `created_at`, `updated_at`, `deleted_at`) VALUES (1247137066804862986, 1247136775485284354, 1247136775460118530, '账号锁定策略维护', 'platform:security:account:lockout:update', '1', '2', '2', NULL, b'0', '0', '0', '账号锁定策略更新（按用户类型 upsert，不允许删除）', '2026-08-25 00:00:00', '2026-08-25 00:00:00', NULL);
...
INSERT INTO `platform_permission` (`id`, `app_id`, `pid`, `name`, `code`, `type`, `node_type`, `source_type`, `source_id`, `managed`, `org_type`, `status`, `remark`, `created_at`, `updated_at`, `deleted_at`) VALUES (1247138952089985025, 1247138809458483202, 1247138809424928770, '成员管理', 'org:contacts:user:**', '0', '1', '1', 1247138952148705281, b'1', '1', '0', '', '2026-06-22 10:30:58', '2026-06-22 18:59:26', NULL);
INSERT INTO `platform_permission` (`id`, `app_id`, `pid`, `name`, `code`, `type`, `node_type`, `source_type`, `source_id`, `managed`, `org_type`, `status`, `remark`, `created_at`, `updated_at`, `deleted_at`) VALUES (1247138998533513218, 1247138809458483202, 1247138809424928770, '部门管理', 'org:contacts:dept:**', '0', '1', '1', 1247138998588039169, b'1', '1', '0', '', '2026-06-22 10:31:09', '2026-06-22 19:02:51', NULL);
INSERT INTO `platform_permission` (`id`, `app_id`, `pid`, `name`, `code`, `type`, `node_type`, `source_type`, `source_id`, `managed`, `org_type`, `status`, `remark`, `created_at`, `updated_at`, `deleted_at`) VALUES (1247139048185683970, 1247138809458483202, 1247138809424928770, '角色管理', 'org:contacts:role:**', '0', '1', '1', 1247139048244404225, b'1', '1', '0', '', '2026-06-22 10:31:21', '2026-06-22 19:05:05', NULL);
INSERT INTO `platform_permission` (`id`, `app_id`, `pid`, `name`, `code`, `type`, `node_type`, `source_type`, `source_id`, `managed`, `org_type`, `status`, `remark`, `created_at`, `updated_at`, `deleted_at`) VALUES (1247139193186967553, 1247138809458483202, 1247138809424928770, '权限管理', 'org:contacts:auth:**', '0', '1', '1', 1247139193258270721, b'1', '1', '0', '', '2026-06-22 10:31:55', '2026-06-22 19:05:33', NULL);
...
INSERT INTO `platform_permission` (`id`, `app_id`, `pid`, `name`, `code`, `type`, `node_type`, `source_type`, `source_id`, `managed`, `org_type`, `status`, `remark`, `created_at`, `updated_at`, `deleted_at`) VALUES (1247266910431633410, 1247138809458483202, 1247138952089985025, '成员查询', 'org:contacts:user:query', '0', '1', '1', 1247266910561656833, b'1', '1', '0', '', '2026-06-22 18:59:26', '2026-06-22 18:59:26', NULL);
INSERT INTO `platform_permission` (`id`, `app_id`, `pid`, `name`, `code`, `type`, `node_type`, `source_type`, `source_id`, `managed`, `org_type`, `status`, `remark`, `created_at`, `updated_at`, `deleted_at`) VALUES (1247267606677708802, 1247138809458483202, 1247138998533513218, '部门查询', 'org:contacts:dept:query', '0', '1', '1', 1247267606753206273, b'1', '1', '0', '', '2026-06-22 19:02:12', '2026-06-22 19:02:12', NULL);
INSERT INTO `platform_permission` (`id`, `app_id`, `pid`, `name`, `code`, `type`, `node_type`, `source_type`, `source_id`, `managed`, `org_type`, `status`, `remark`, `created_at`, `updated_at`, `deleted_at`) VALUES (1247268326986506241, 1247138809458483202, 1247139048185683970, '角色查询', 'org:contacts:role:query', '0', '1', '1', 1247268327103946753, b'1', '1', '0', '', '2026-06-22 19:05:03', '2026-06-22 19:05:03', NULL);
INSERT INTO `platform_permission` (`id`, `app_id`, `pid`, `name`, `code`, `type`, `node_type`, `source_type`, `source_id`, `managed`, `org_type`, `status`, `remark`, `created_at`, `updated_at`, `deleted_at`) VALUES (1247268448994615298, 1247138809458483202, 1247139193186967553, '权限查询', 'org:contacts:auth:query', '0', '1', '1', 1247268449049141250, b'1', '1', '0', '', '2026-06-22 19:05:32', '2026-06-22 19:05:33', NULL);
INSERT INTO `platform_permission` (`id`, `app_id`, `pid`, `name`, `code`, `type`, `node_type`, `source_type`, `source_id`, `managed`, `org_type`, `status`, `remark`, `created_at`, `updated_at`, `deleted_at`) VALUES (1260960888831311873, 1247136775485284354, 1247136775460118530, '访问防护', 'platform:security:access-protection', '0', '1', '1', 1260960888923586562, b'1', '0', '0', '', '2026-07-30 13:54:25', '2026-07-30 13:54:25', NULL);
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=405 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='统一安全事件（canonical）';

-- ----------------------------
-- Records of security_event
-- ----------------------------
BEGIN;
INSERT INTO `security_event` (`id`, `event_id`, `event_type`, `event_category`, `priority`, `occurred_at`, `received_at`, `tenant_id`, `user_id`, `user_type`, `account`, `client_id`, `app_id`, `session_id`, `device_id`, `client_ip`, `request_uri`, `user_agent`, `result`, `reason_code`, `reason_detail`, `source_module`, `source`, `operator_id`, `operator_name`, `trace_id`, `extension`) VALUES (399, '02e8700f1a834259b8176f73e43efb1b', 'LOGIN_FAILURE', 'AUTH', 'BEST_EFFORT', '2026-08-13 14:44:27', '2026-08-13 14:44:27', NULL, 1247573787441106945, 'ADMIN', NULL, NULL, NULL, NULL, NULL, '192.168.1.163', NULL, NULL, 'FAILURE', NULL, 'S0400', 'PMS', 'AUTH', NULL, NULL, NULL, NULL);
INSERT INTO `security_event` (`id`, `event_id`, `event_type`, `event_category`, `priority`, `occurred_at`, `received_at`, `tenant_id`, `user_id`, `user_type`, `account`, `client_id`, `app_id`, `session_id`, `device_id`, `client_ip`, `request_uri`, `user_agent`, `result`, `reason_code`, `reason_detail`, `source_module`, `source`, `operator_id`, `operator_name`, `trace_id`, `extension`) VALUES (400, '2ca572da24d944029e590013baf84a5a', 'LOGIN_FAILURE', 'AUTH', 'BEST_EFFORT', '2026-08-13 14:44:34', '2026-08-13 14:44:34', NULL, 1247573787441106945, 'ADMIN', NULL, NULL, NULL, NULL, NULL, '192.168.1.163', NULL, NULL, 'FAILURE', NULL, 'S0400', 'PMS', 'AUTH', NULL, NULL, NULL, NULL);
INSERT INTO `security_event` (`id`, `event_id`, `event_type`, `event_category`, `priority`, `occurred_at`, `received_at`, `tenant_id`, `user_id`, `user_type`, `account`, `client_id`, `app_id`, `session_id`, `device_id`, `client_ip`, `request_uri`, `user_agent`, `result`, `reason_code`, `reason_detail`, `source_module`, `source`, `operator_id`, `operator_name`, `trace_id`, `extension`) VALUES (401, '77c23c3511ef4ec3843aae1b45f3e54f', 'LOGIN_FAILURE', 'AUTH', 'BEST_EFFORT', '2026-08-13 14:44:40', '2026-08-13 14:44:40', NULL, 1247573787441106945, 'ADMIN', NULL, NULL, NULL, NULL, NULL, '192.168.1.163', NULL, NULL, 'FAILURE', NULL, 'S0400', 'PMS', 'AUTH', NULL, NULL, NULL, NULL);
INSERT INTO `security_event` (`id`, `event_id`, `event_type`, `event_category`, `priority`, `occurred_at`, `received_at`, `tenant_id`, `user_id`, `user_type`, `account`, `client_id`, `app_id`, `session_id`, `device_id`, `client_ip`, `request_uri`, `user_agent`, `result`, `reason_code`, `reason_detail`, `source_module`, `source`, `operator_id`, `operator_name`, `trace_id`, `extension`) VALUES (402, '8e3eaa3bc140476ebe026e5c725c0b53', 'LOGIN_FAILURE', 'AUTH', 'BEST_EFFORT', '2026-08-13 14:46:09', '2026-08-13 14:46:10', NULL, 1247573787441106945, 'ADMIN', NULL, NULL, NULL, NULL, NULL, '192.168.1.163', NULL, NULL, 'FAILURE', NULL, 'S0400', 'PMS', 'AUTH', NULL, NULL, NULL, NULL);
INSERT INTO `security_event` (`id`, `event_id`, `event_type`, `event_category`, `priority`, `occurred_at`, `received_at`, `tenant_id`, `user_id`, `user_type`, `account`, `client_id`, `app_id`, `session_id`, `device_id`, `client_ip`, `request_uri`, `user_agent`, `result`, `reason_code`, `reason_detail`, `source_module`, `source`, `operator_id`, `operator_name`, `trace_id`, `extension`) VALUES (403, 'e0d0c288cd2a4035943661040f502bbb', 'ACCOUNT_LOCKED', 'ACCOUNT', 'DURABLE', '2026-08-13 14:46:10', '2026-08-13 14:46:10', NULL, 1247573787441106945, 'ADMIN', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'LOGIN_FAIL', '登录失败次数超限', 'PMS', 'SYSTEM', NULL, NULL, NULL, NULL);
INSERT INTO `security_event` (`id`, `event_id`, `event_type`, `event_category`, `priority`, `occurred_at`, `received_at`, `tenant_id`, `user_id`, `user_type`, `account`, `client_id`, `app_id`, `session_id`, `device_id`, `client_ip`, `request_uri`, `user_agent`, `result`, `reason_code`, `reason_detail`, `source_module`, `source`, `operator_id`, `operator_name`, `trace_id`, `extension`) VALUES (404, '5744feee3820418c924a1af20518d596', 'ACCOUNT_UNLOCKED', 'ACCOUNT', 'DURABLE', '2026-08-13 15:17:00', '2026-08-13 15:17:00', NULL, 1247573787441106945, 'ADMIN', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '临时锁定已过期', 'PMS', 'SYSTEM', NULL, NULL, NULL, NULL);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_user` (`id`, `username`, `password`, `must_change_pwd`, `password_changed_at`, `nickname`, `phone`, `email`, `avatar`, `enabled`, `locked`, `last_login_at`, `last_login_ip`, `version`, `created_at`, `updated_at`, `deleted_at`) VALUES (1, 'platform', '{bcrypt}$2a$10$Giv1Bv2iegN4.rzcgmcKXemLKeVhOBBf3XUJcgZz64KaLdCsSDMBi', 0, '2026-07-09 13:30:14', '超级管理员', '18888888888', 'admin@ingot.com', 'ingot/user/avatar/1/logo.png', 1, 0, '2026-08-13 12:50:38', '192.168.1.163', 0, '2021-01-03 11:02:46', '2026-05-19 09:22:01', NULL);
...
INSERT INTO `sys_user` (`id`, `username`, `password`, `must_change_pwd`, `password_changed_at`, `nickname`, `phone`, `email`, `avatar`, `enabled`, `locked`, `last_login_at`, `last_login_ip`, `version`, `created_at`, `updated_at`, `deleted_at`) VALUES (1221851150714556417, 'test1', '{bcrypt}$2a$10$afqwEGofq/Ouukd38eMape79zsxixwUoYxhGtSVF647Z160HW5YMy', 1, '2026-07-24 08:43:20', '测试初始化密码', '123', NULL, NULL, 1, 0, '2026-07-18 15:56:28', '192.168.1.139', 0, '2026-04-13 15:46:16', NULL, NULL);
...
INSERT INTO `sys_user` (`id`, `username`, `password`, `must_change_pwd`, `password_changed_at`, `nickname`, `phone`, `email`, `avatar`, `enabled`, `locked`, `last_login_at`, `last_login_ip`, `version`, `created_at`, `updated_at`, `deleted_at`) VALUES (1247573787441106945, '111', '{bcrypt}$2a$10$n3u8LtbSC8X11ztpXNjh/e1Z781.5opyk1kJ0lF.lkQzg5xYA6U/y', 0, '2026-08-13 13:14:33', '测试1', '111', NULL, NULL, 1, 0, '2026-08-13 13:14:41', '192.168.1.163', 0, '2026-06-23 15:18:51', NULL, NULL);
...
INSERT INTO `sys_user_tenant` (`id`, `user_id`, `tenant_id`, `main`, `name`, `avatar`, `created_at`) VALUES (1247483762523246594, 1247483762300948482, 1, b'1', '英格特云', 'http://ingot-cloud:9090/ingot/public/tenant/logo.png?t=1710140674513', '2026-06-23 09:21:07');
INSERT INTO `sys_user_tenant` (`id`, `user_id`, `tenant_id`, `main`, `name`, `avatar`, `created_at`) VALUES (1247573787944423426, 1247573787441106945, 1, b'1', '英格特云', 'http://ingot-cloud:9090/ingot/public/tenant/logo.png?t=1710140674513', '2026-06-23 15:18:51');
COMMIT;
...
INSERT INTO `tenant_role_user_private` (`id`, `tenant_id`, `role_id`, `platform_role`, `user_id`, `dept_id`) VALUES (1247484009056047105, 1, 1171747701302751233, b'0', 1247483762300948482, 1171520634774614018);
...
INSERT INTO `tenant_user_dept_private` (`id`, `tenant_id`, `user_id`, `dept_id`) VALUES (1247483762640687105, 1, 1247483762300948482, 1171517787697836033);
