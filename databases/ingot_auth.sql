...
INSERT INTO `oauth2_registered_client` (`id`, `client_id`, `client_id_issued_at`, `client_secret`, `client_secret_expires_at`, `client_name`, `client_authentication_methods`, `authorization_grant_types`, `redirect_uris`, `post_logout_redirect_uris`, `scopes`, `client_settings`, `token_settings`, `updated_at`, `deleted_at`) VALUES ('ingot', 'ingot', '2020-11-20 15:57:29', '{bcrypt}$2a$10$VWiugTVdl78OevKicpEYiOCl/l3r61g6jT.hRDTQc2ByDg1eDXC.a', NULL, 'Ingot管理平台', 'client_secret_basic,none,pre_auth', 'refresh_token,client_credentials,authorization_code,pre_authorization_code,password', 'http://localhost:5798/sso_callback,http://127.0.0.1:5798/sso_callback,http://ingot.localhost:5798/sso_callback', NULL, 'system', '{\"@class\":\"java.util.Collections$UnmodifiableMap\",\"ingot.settings.client.status\":\"0\",\"settings.client.require-proof-key\":true,\"settings.client.require-authorization-consent\":false}', '{\"@class\":\"java.util.Collections$UnmodifiableMap\",\"settings.token.reuse-refresh-tokens\":false,\"settings.token.id-token-signature-algorithm\":[\"org.springframework.security.oauth2.jose.jws.SignatureAlgorithm\",\"RS256\"],\"settings.token.access-token-time-to-live\":[\"java.time.Duration\",7200.000000000],\"ingot.settings.token.auth-type\":\"1\",\"settings.token.access-token-format\":{\"@class\":\"org.springframework.security.oauth2.server.authorization.settings.OAuth2TokenFormat\",\"value\":\"self-contained\"},\"settings.token.refresh-token-time-to-live\":[\"java.time.Duration\",604800.000000000],\"settings.token.authorization-code-time-to-live\":[\"java.time.Duration\",300.000000000]}', '2026-01-16 16:14:24', NULL);
INSERT INTO `oauth2_registered_client` (`id`, `client_id`, `client_id_issued_at`, `client_secret`, `client_secret_expires_at`, `client_name`, `client_authentication_methods`, `authorization_grant_types`, `redirect_uris`, `post_logout_redirect_uris`, `scopes`, `client_settings`, `token_settings`, `updated_at`, `deleted_at`) VALUES ('in-bff-platform', 'in-bff-platform', '2026-09-17 00:00:00', NULL, NULL, 'BFF平台入口', 'none,pre_auth_none', 'pre_authorization_code,authorization_code', 'http://localhost:5400/bff/auth/platform/callback,https://bff.ingotcloud.top/bff/auth/platform/callback', NULL, 'system', '{\"@class\":\"java.util.Collections$UnmodifiableMap\",\"ingot.settings.client.status\":\"0\",\"settings.client.require-proof-key\":true,\"settings.client.require-authorization-consent\":false}', '{\"@class\":\"java.util.Collections$UnmodifiableMap\",\"settings.token.reuse-refresh-tokens\":false,\"settings.token.id-token-signature-algorithm\":[\"org.springframework.security.oauth2.jose.jws.SignatureAlgorithm\",\"RS256\"],\"settings.token.access-token-time-to-live\":[\"java.time.Duration\",7200.000000000],\"ingot.settings.token.auth-type\":\"1\",\"settings.token.access-token-format\":{\"@class\":\"org.springframework.security.oauth2.server.authorization.settings.OAuth2TokenFormat\",\"value\":\"self-contained\"},\"settings.token.refresh-token-time-to-live\":[\"java.time.Duration\",604800.000000000],\"settings.token.authorization-code-time-to-live\":[\"java.time.Duration\",300.000000000]}', '2026-09-17 00:00:00', NULL);
INSERT INTO `oauth2_registered_client` (`id`, `client_id`, `client_id_issued_at`, `client_secret`, `client_secret_expires_at`, `client_name`, `client_authentication_methods`, `authorization_grant_types`, `redirect_uris`, `post_logout_redirect_uris`, `scopes`, `client_settings`, `token_settings`, `updated_at`, `deleted_at`) VALUES ('in-bff-tenant', 'in-bff-tenant', '2026-09-17 00:00:00', NULL, NULL, 'BFF租户入口', 'none,pre_auth_none', 'pre_authorization_code,authorization_code', 'http://localhost:5400/bff/auth/tenant/callback,https://bff.ingotcloud.top/bff/auth/tenant/callback', NULL, 'system', '{\"@class\":\"java.util.Collections$UnmodifiableMap\",\"ingot.settings.client.status\":\"0\",\"settings.client.require-proof-key\":true,\"settings.client.require-authorization-consent\":false}', '{\"@class\":\"java.util.Collections$UnmodifiableMap\",\"settings.token.reuse-refresh-tokens\":false,\"settings.token.id-token-signature-algorithm\":[\"org.springframework.security.oauth2.jose.jws.SignatureAlgorithm\",\"RS256\"],\"settings.token.access-token-time-to-live\":[\"java.time.Duration\",7200.000000000],\"ingot.settings.token.auth-type\":\"1\",\"settings.token.access-token-format\":{\"@class\":\"org.springframework.security.oauth2.server.authorization.settings.OAuth2TokenFormat\",\"value\":\"self-contained\"},\"settings.token.refresh-token-time-to-live\":[\"java.time.Duration\",604800.000000000],\"settings.token.authorization-code-time-to-live\":[\"java.time.Duration\",300.000000000]}', '2026-09-17 00:00:00', NULL);
COMMIT;
