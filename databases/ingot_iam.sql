...
INSERT INTO `iam_menu` (`id`, `application_id`, `parent_id`, `name`, `path`, `view_path`, `route_name`, `icon`, `kind`, `match_mode`, `access_mode`, `sort_order`, `enabled`, `version`) VALUES (130008, 100001, 130007, '平台人员', '/platform/iam/personnel', 'platform.iam.personnel', 'platform.iam.personnel', NULL, 'PAGE', 'ANY', 'ACTION', 1, 1, 0);
INSERT INTO `iam_menu` (`id`, `application_id`, `parent_id`, `name`, `path`, `view_path`, `route_name`, `icon`, `kind`, `match_mode`, `access_mode`, `sort_order`, `enabled`, `version`) VALUES (130009, 100001, 130007, '角色与授权', '/platform/iam/authorization', 'platform.iam.authorization', 'platform.iam.authorization', NULL, 'PAGE', 'ANY', 'ACTION', 2, 1, 0);
