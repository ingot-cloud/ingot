---
name: java-enum-contract
description: Define and review Java business enums using CommonStatusEnum annotations, EnumUtils lookup, Jackson JSON literals, and MyBatis-Plus @EnumValue. Use when adding or changing Java enums, EnumUtils, @JsonCreator, @JsonValue, CompositeEnumTypeHandler, or VALUE_* compile-time constants.
---
