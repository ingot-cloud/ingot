---
name: spring-constructor-injection
description: Add, refactor, or review Spring Bean dependencies in this repository using final fields and Lombok RequiredArgsConstructor. Use when changing component injection or migrating field/setter injection; preserve qualifiers, optionality and inheritance. Do not trigger a repository-wide cleanup or change test-framework injection.
---
