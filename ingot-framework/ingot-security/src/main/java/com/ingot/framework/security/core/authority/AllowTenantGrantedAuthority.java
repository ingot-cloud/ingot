 ...
 * <p>Time         : 10:09 AM.</p>
 */
public class AllowTenantGrantedAuthority implements InGrantedAuthority<TenantMainDTO> {
    private final TenantMainDTO allow;
    private final ObjectMapper objectMapper = new ObjectMapper();

    public AllowTenantGrantedAuthority(TenantMainDTO allow) {
