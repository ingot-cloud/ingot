package com.ingot.framework.security.account.web.support;
...
/**
 * Web/登录认证场景共享工具的自动配置。
 * <p>{@link CredentialSecurityService} / {@link LockStatePort} / {@link AccountLockoutPolicyLoader}
...
public class AccountWebSupportAutoConfiguration {
    ...
    public AuthContextSupport authContextSupport(
            ...
            ObjectProvider<AccountLockoutPolicyLoader> lockoutPolicyLoader,
        ...
        return new AuthContextSupport(
                ...
                lockoutPolicyLoader.getIfAvailable(),
