...
public enum AudienceKind {
    ...
    private static final Map<String, AudienceKind> BY_VALUE = EnumUtils.index(values(), AudienceKind::getValue);
     ...
     */
    @JsonCreator
    public static AudienceKind getEnum(String value) {
