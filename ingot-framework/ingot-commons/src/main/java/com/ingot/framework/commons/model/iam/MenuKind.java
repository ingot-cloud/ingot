...
public enum MenuKind {
    ...
    private static final Map<String, MenuKind> BY_VALUE = EnumUtils.index(values(), MenuKind::getValue);
     ...
     */
    @JsonCreator
    public static MenuKind getEnum(String value) {
