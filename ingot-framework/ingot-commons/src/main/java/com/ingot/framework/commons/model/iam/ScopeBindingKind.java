...
/**
 * <p>区分授权时绑定的部门 ID 集合与资源对象 ID 集合。</p>
 *
 * @author jy
 * @since 1.0.0
 */
...
public enum ScopeBindingKind {
    ...
    private static final Map<String, ScopeBindingKind> BY_VALUE = EnumUtils.index(values(), ScopeBindingKind::getValue);
     ...
     */
    @JsonCreator
    public static ScopeBindingKind getEnum(String value) {
