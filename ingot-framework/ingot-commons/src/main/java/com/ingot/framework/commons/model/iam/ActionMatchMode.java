...
public enum ActionMatchMode {
    ...
    private static final Map<String, ActionMatchMode> BY_VALUE = EnumUtils.index(values(), ActionMatchMode::getValue);
     ...
     */
    @JsonCreator
    public static ActionMatchMode getEnum(String value) {
