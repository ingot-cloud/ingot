...
public enum RoleOrigin {
    ...
    private static final Map<String, RoleOrigin> BY_VALUE = EnumUtils.index(values(), RoleOrigin::getValue);
     ...
     */
    @JsonCreator
    public static RoleOrigin getEnum(String value) {
