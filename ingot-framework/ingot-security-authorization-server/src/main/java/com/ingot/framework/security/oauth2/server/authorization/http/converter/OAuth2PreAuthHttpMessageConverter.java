 ...
 * <p>Time         : 10:57 AM.</p>
 */
public class OAuth2PreAuthHttpMessageConverter extends AbstractHttpMessageConverter<OAuth2PreAuthorizationAuthenticationToken> {
    private static final ParameterizedTypeReference<Map<String, Object>> STRING_OBJECT_MAP = new ParameterizedTypeReference<Map<String, Object>>() {
    };
    private final GenericHttpMessageConverter<Object> jsonMessageConverter = HttpMessageConverters.getJsonMessageConverter();
    private final Converter<OAuth2PreAuthorizationAuthenticationToken, Map<String, Object>> tokenConverter = new OAuth2PreAuthorizationAuthenticationTokenConverter();

    @Override
    protected boolean supports(@NonNull Class<?> clazz) {
        return OAuth2PreAuthorizationAuthenticationToken.class.isAssignableFrom(clazz);
    }
    ...
    @Override
    protected void writeInternal(@NonNull OAuth2PreAuthorizationAuthenticationToken token,
