...
public class LocalChallengePolicyService implements ChallengePolicyService {
    ...
    private final LazyDerivedCache<CompiledChallengePolicy> cache;
    private final AtomicLong version = new AtomicLong();

    public LocalChallengePolicyService(ChallengeProperties properties) {
    ...
    private CompiledChallengePolicy compile() {
        ...
        log.info("[Challenge] local policies compiled, size={} version={}", c.all().size(), v);
        return c;
    }
}
