...
public class ResourcePermitServiceImpl implements ResourcePermitService {
     ...
     */
    @Override public List<String> allResourcePermitAntPatterns() {
     ...
     */
    @Override public boolean resourcePermit(String requestURI) {
     ...
     * @param requestURI check url
     */
    @Override public boolean userPermit(String requestURI) {
