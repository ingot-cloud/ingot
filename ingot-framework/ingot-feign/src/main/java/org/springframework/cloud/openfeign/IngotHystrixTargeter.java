...
/**
 * <p>Description  : IngotHystrixTargeter.</p>
 * <p>Author       : wangchao.</p>
 * <p>Date         : 2019/6/26.</p>
 * <p>Time         : 3:44 PM.</p>
 */
@SuppressWarnings("unchecked")
public class IngotHystrixTargeter implements Targeter {

    @Override public <T> T target(FeignClientFactoryBean factory, Feign.Builder feign, FeignContext context,
        ...
        IngotFallbackFactory ingotFallbackFactory = new IngotFallbackFactory(target);
        return (T) builder.target(target, ingotFallbackFactory);
    }
    ...
    @Nullable private <T> T getOptional(String feignClientName, FeignContext context, Class<T> beanType) {
