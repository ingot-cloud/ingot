package com.ingot.framework.id.leaf.segment;

import java.util.*;
import java.util.concurrent.*;
import java.util.concurrent.atomic.AtomicLong;

import com.ingot.framework.id.leaf.IDGen;
...
import com.ingot.framework.id.leaf.segment.model.Segment;
import com.ingot.framework.id.leaf.segment.model.SegmentBuffer;
...
public class SegmentIDGenImpl implements IDGen {
    ...
    private final ExecutorService service = new ThreadPoolExecutor(5,
            Integer.MAX_VALUE,
            60L,
