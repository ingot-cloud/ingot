package com.ingot.frameword.id.config;

import javax.sql.DataSource;

import com.baomidou.mybatisplus.autoconfigure.IdentifierGeneratorAutoConfiguration;
import com.baomidou.mybatisplus.core.incrementer.IdentifierGenerator;
import com.ingot.frameword.id.BizGenerator;
import com.ingot.frameword.id.IdGenerator;
import com.ingot.frameword.id.leaf.DefaultBizGenerator;
import com.ingot.frameword.id.mybatis.IngotIdentifierGenerator;
import com.ingot.frameword.id.properties.IdProperties;
import com.ingot.frameword.id.snowflake.impl.SnowFlakeIdGenerator;
import com.ingot.frameword.id.snowflake.worker.WorkerIdFactory;
import com.ingot.frameword.id.snowflake.worker.impl.MachineWorkerIdFactory;
import com.ingot.frameword.id.snowflake.worker.impl.RedisWorkerIdFactory;
