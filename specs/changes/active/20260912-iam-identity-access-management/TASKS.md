...
对应任务仍未勾选：T05 的 C07/C08/C09/C16/C19 代码已落地，仍缺 A01–A03、A09、A18、A21、A23、A26、A28 真实进程与 HTTP 证据；T11 的 C04/C05 代码已落地，仍缺 A13、A14、A20 真实 HTTP/SQL 证据；T12 的 C14/C15/C18 代码已落地，仍缺 A17、A19、A24 真实 HTTP 证据；T10 的 C09/C13 代码已落地，仍缺 A10、A27 真实多实例导出证据；T18 的 C17 代码已落地，仍缺 A22、A23 真实进程与 RPC 证据；T13 的契约 JSON 已重发，仍缺 A23/A24/A28 真实 HTTP。A21 的人工步骤已写入 MANUAL-VERIFICATION。T16 已开始：隔离 MySQL 结构/种子与自动化回归已跑，HTTP/镜像/多实例仍待人工。

待实施顺序：T16 剩余人工项（独立库 0.1、镜像/Gateway A18、冷启动登录 A21、各业务 HTTP 与多实例）。
