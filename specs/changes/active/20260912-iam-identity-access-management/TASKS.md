...
| [x] | T06.entitlement-union | 已实现 | InitializationCatalogTest / EntitlementServiceTest | 未执行 | 未执行 | EntitlementResolver 计算套餐∪自选∪必要 baseline；preview/create/replace 写 PLAN/MANUAL；SUMMARY 列表 | 不补勾 T06 |
