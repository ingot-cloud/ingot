...
import com.ingot.common.core.utils.DigestUtils;

import static com.ingot.common.core.constants.SecurityConstants.AUTH_TYPE_STANDARD;
import static com.ingot.common.core.constants.SecurityConstants.AUTH_TYPE_UNIQUE;
...
public interface RedisConstants {
    ...
    static String userUniqueAccessTokenKey(String userId, String userName){
        return userTokenPreKey(userId, userName) + AUTH_TYPE_UNIQUE;
    }
    ...
    static String userStandardAccessTokenKey(String token, String userId, String userName){
        ...
        return userTokenPreKey(userId, userName) + DigestUtils.sha256(token) + AUTH_TYPE_STANDARD;
    }
